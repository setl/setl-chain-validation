...
public class PoaAssetIssueTx extends AssetIssueTx implements HasNamespace, HasClassId, HasToAddress, HasAmount, HasProtocol {

  public static final TxType TXT = TxType.POA_ISSUE_ASSET;

  private static final Logger logger = LoggerFactory.getLogger(PoaAssetIssueTx.class);


  /**
   * Accept an Object[] and return a PoaAssetIssueTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned PoaAssetIssueTx object
   */
  public static PoaAssetIssueTx decodeTX(Object[] encodedTx) {
  ...
  /**
   * Accept MPWrappedArray argument and create PoaAssetIssueTx from it.
   *
   * @param txData : The input MPWrappedArray object
   *
   * @return : The constructed PoaAssetIssueTx object
   */
  public static PoaAssetIssueTx decodeTX(MPWrappedArray txData) {
    ...
    return new PoaAssetIssueTx(chainId,
        int1,
        hash,
        nonce,
        updated,
  ...
  public PoaAssetIssueTx(int chainId,
      int int1,
      String hash,
      long nonce,
      boolean updated,
   ...
   * @param toCopy :
   */
  public PoaAssetIssueTx(PoaAssetIssueTx toCopy) {
