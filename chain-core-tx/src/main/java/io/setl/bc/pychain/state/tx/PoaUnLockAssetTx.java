 ...
 * PoaUnLockAssetTx.
 */
public class PoaUnLockAssetTx extends UnLockAssetTx implements HasNamespace, HasClassId, HasProtocol {

  public static final TxType TXT = TxType.POA_UNLOCK_ASSET;

  private static final Logger logger = LoggerFactory.getLogger(PoaUnLockAssetTx.class);


  /**
   * Accept an Object[] and return a PoaUnLockAssetTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned PoaUnLockAssetTx object
   */
  public static PoaUnLockAssetTx decodeTX(Object[] encodedTx) {
   ...
   *
   * @return :      An PoaUnLockAssetTx object
   */
  public static PoaUnLockAssetTx decodeTX(MPWrappedArray encodedTX) {
    ...
    return new PoaUnLockAssetTx(chainId,
        hash,
        nonce,
        updated,
        fromPubKey,
  ...
  public PoaUnLockAssetTx(int chainId,
      String hash,
      long nonce,
      boolean updated,
      String fromPubKey,
   ...
   * @param toCopy :
   */
  public PoaUnLockAssetTx(PoaUnLockAssetTx toCopy) {
