 ...
 * UnLockAssetTx.
 */
public class UnLockAssetTx extends AbstractTx implements HasNamespace, HasClassId {

  public static final TxType TXT = TxType.UNLOCK_ASSET;

  private static final Logger logger = LoggerFactory.getLogger(UnLockAssetTx.class);


  /**
   * Accept an Object[] and return a UnLockAssetTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned UnLockAssetTx object
   */
  public static UnLockAssetTx decodeTX(Object[] encodedTx) {
   ...
   *
   * @return :      An UnLockAssetTx object
   */
  public static UnLockAssetTx decodeTX(MPWrappedArray encodedTX) {
    ...
    int height = encodedTX.asInt(14);
    return new UnLockAssetTx(chainId, hash, nonce, updated, fromPubKey, fromAddress, nameSpace, classId, metadata, signature, height, poa, timestamp);
  }
  ...
  public UnLockAssetTx(
      int chainId, String hash, long nonce, boolean updated, String fromPubKey, String fromAddress, String nameSpace, String classId,
      String metadata, String signature, int height, String poa, long timestamp
  ) {
   ...
   * @param toCopy :
   */
  public UnLockAssetTx(UnLockAssetTx toCopy) {
    //  ensure super class object construction
    //
    super(toCopy);
    //  load object attributes
