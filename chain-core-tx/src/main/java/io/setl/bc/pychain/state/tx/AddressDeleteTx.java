...
public class AddressDeleteTx extends AbstractTx {

  public static final TxType TXT = TxType.DELETE_ADDRESS;

  private static final Logger logger = LoggerFactory.getLogger(AddressDeleteTx.class);
   ...
   */
  public static AddressDeleteTx decodeTX(Object[] encodedTx) {
   ...
   * @return : The returned RegisterAddressTx object
   */
  public static AddressDeleteTx decodeTX(MPWrappedArray vat) {
    ...
    String protocol = vat.asString(10);
    String metadata = vat.asString(11);
    String signature = vat.asString(12);
    int height = vat.asInt(13);
    return new AddressDeleteTx(chainId, int1, hash, nonce, updated, fromPubKey, fromAddress, protocol, metadata, signature, height, poa, timestamp);
    // thisTX.priority = -20
  }
   ...
   * @param toCopy :
   */
  public AddressDeleteTx(AddressDeleteTx toCopy) {
   ...
   * @param protocol    : Txn protocol, info only
  ...
  public String toString() {
    return String.format("%s from:%s to:%s", super.toString(), fromAddress, protocol);
  }
}
