...
public class PoaLockAssetTx extends LockAssetTx implements HasNamespace, HasClassId, HasProtocol {

  public static final TxType TXT = TxType.POA_LOCK_ASSET;

  private static final Logger logger = LoggerFactory.getLogger(PoaLockAssetTx.class);


  /**
   * Accept an Object[] and return a PoaLockAssetTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned PoaLockAssetTx object
   */
  public static PoaLockAssetTx decodeTX(Object[] encodedTx) {
   ...
   *
   * @return :      An PoaLockAssetTx object
   */
  public static PoaLockAssetTx decodeTX(MPWrappedArray encodedTX) {
    ...
    String lockdetails = encodedTX.asString(14);
    ...
    return new PoaLockAssetTx(chainId,
        int1,
        hash,
        nonce,
        updated,
  ...
  public PoaLockAssetTx(int chainId,
      int int1,
      String hash,
      long nonce,
      boolean updated,
   ...
   * @param toCopy :
   */
  public PoaLockAssetTx(PoaLockAssetTx toCopy) {
