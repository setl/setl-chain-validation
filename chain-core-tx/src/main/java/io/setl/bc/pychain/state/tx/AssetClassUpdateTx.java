...
public class AssetClassUpdateTx extends AbstractTx implements HasNamespace, HasClassId {

  public static final TxType TXT = TxType.UPDATE_ASSET_CLASS;

  private static final Logger logger = LoggerFactory.getLogger(AssetClassUpdateTx.class);


  /**
   * Accept an Object[] and return a AssetClassUpdateTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned AssetClassUpdateTx object
   */
  public static AssetClassUpdateTx decodeTX(Object[] encodedTx) {
   ...
   *
   * @return :      An AssetClassUpdateTx object
   */
  public static AssetClassUpdateTx decodeTX(MPWrappedArray encodedTX) {
   ...
   * @param toCopy :
   */
  public AssetClassUpdateTx(AssetClassUpdateTx toCopy) {
