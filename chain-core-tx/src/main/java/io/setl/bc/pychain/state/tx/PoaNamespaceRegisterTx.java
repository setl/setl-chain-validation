...
public class PoaNamespaceRegisterTx extends NamespaceRegisterTx implements HasNamespace, HasProtocol {

  public static final TxType TXT = TxType.POA_REGISTER_NAMESPACE;

  private static final Logger logger = LoggerFactory.getLogger(PoaNamespaceRegisterTx.class);


  /**
   * Accept an Object[] and return a PoaNamespaceRegisterTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned PoaNamespaceRegisterTx object
   */
  public static PoaNamespaceRegisterTx decodeTX(Object[] encodedTx) {
  ...
  /**
   * Accept an MPWrappedArray object and return a PoaNamespaceRegisterTx.
   *
   * @param encodedTX : The input MPWrappedArray object
   *
   * @return : The returned PoaNamespaceRegisterTx object
   */
  public static PoaNamespaceRegisterTx decodeTX(MPWrappedArray encodedTX) {
    ...
    return new PoaNamespaceRegisterTx(chainId,
        hash,
        nonce,
        updated,
        fromPubKey,
   ...
   * @param toCopy :
   */
  public PoaNamespaceRegisterTx(PoaNamespaceRegisterTx toCopy) {
  ...
  public PoaNamespaceRegisterTx(int chainId,
      String hash,
      long nonce,
      boolean updated,
      String fromPubKey,
