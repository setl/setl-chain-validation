...
public class PoaAssetClassRegisterTx extends AssetClassRegisterTx implements HasNamespace, HasClassId, HasProtocol {

  public static final TxType TXT = TxType.POA_REGISTER_ASSET_CLASS;

  private static final Logger logger = LoggerFactory.getLogger(PoaAssetClassRegisterTx.class);
   ...
   */
  public static PoaAssetClassRegisterTx decodeTX(Object[] encodedTx) {
   ...
   */
  public static PoaAssetClassRegisterTx decodeTX(MPWrappedArray encodedTX) {
    ...
    return new PoaAssetClassRegisterTx(chainId,
        int1,
        hash,
        nonce,
        updated,
  ...
  public PoaAssetClassRegisterTx(int chainId,
      int int1,
      String hash,
      long nonce,
      boolean updated,
   ...
   * @param toCopy :
   */
  public PoaAssetClassRegisterTx(PoaAssetClassRegisterTx toCopy) {
