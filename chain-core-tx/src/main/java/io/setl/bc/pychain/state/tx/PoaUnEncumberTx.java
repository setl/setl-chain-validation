...
public class PoaUnEncumberTx extends UnEncumberTx implements HasNamespace, HasClassId, HasAmount, HasProtocol {

  public static final TxType TXT = TxType.POA_UNENCUMBER_ASSET;

  private static final Logger logger = LoggerFactory.getLogger(PoaUnEncumberTx.class);


  /**
   * Accept an Object[] and return a PoaUnEncumberTx.
   *
   * @param encodedTx : The input  Object[]
   *
   * @return : The returned PoaUnEncumberTx object
   */
  public static PoaUnEncumberTx decodeTX(Object[] encodedTx) {
   ...
   *
   * @return :      An PoaUnEncumberTx object
   */
  public static PoaUnEncumberTx decodeTX(MPWrappedArray encodedTX) {
    ...
    String reference = encodedTX.asString(16);
  ...
  public PoaUnEncumberTx(int chainId,
      String hash,
      long nonce,
      boolean updated,
      String fromPubKey,
   ...
   * @param toCopy :
   */
  public PoaUnEncumberTx(PoaUnEncumberTx toCopy) {
    //  ensure super class object construction
    //
    super(toCopy);
