...
/**
 * Created by nicholaspennington on 30/07/2017.
 */
public class TestMonolithicTransitionWrapped {
  ...
  public void single() throws Exception {
    ...
    singleTransitionTest(
        "src/test/resources/test-transitions/mono/task/9-10/9/50c5f92d6308d398d6fc1b0d9a858d5690ea35e284ea2f37cacd267181b03072",
        "src/test/resources/test-transitions/mono/task/9-10/10/a5b5ee6d1583235a8de97e8cb2f3685027251eb76e8d638087d6870a54812db9",
        "src/test/resources/test-transitions/mono/task/9-10/ca456ce22398f9597865aee004f3b442521212fa42ca01eda60a5af1dd8ab5a2");
  ...
  void validateTransition(ObjectEncodedState s0, ObjectEncodedState s1, Block block)
    ...
    StateSnapshot newSnapWrap = newSnap.createSnapshot();

    TransactionProcessor transactionProcessor = new DefaultProcessor();
    transactionProcessor.processTransactions(orgSnap, block.getTransactions(), block.getTimeStamp(), true);
    ...
    if (!DefaultProcessor.getInstance().processTransactions(
        newSnapWrap, block.getTransactions(), block.getTimeStamp(), true)) {
