...
public class PoaUnlockHoldingTest {

  @Test
  public void getTxType() {

    PoaUnlockHolding thisClass = new PoaUnlockHolding();

    assertEquals(TxType.POA_UNLOCK_ASSET_HOLDING, thisClass.getTxType());
  }
  ...
  public void unlockHoldingUnsigned() throws Exception {
    ...
    String goodHash = "73b10921c004d57bfb62eecd93dcd5fb3835503c6e097c2aa6928ab9968edb86";

    PoaUnlockHoldingTx rVal = PoaUnlockHolding.poaUnlockHoldingUnsigned(
    ...
    PoaUnlockHoldingTx txCopy = new PoaUnlockHoldingTx(rVal);
    txCopy.setHash(Hash.computeHash(txCopy));

    assertEquals("", txCopy.getHash(), goodHash);

    rVal.setHash(null);
    PoaUnlockHolding thisClass = new PoaUnlockHolding(rVal);
    ...
    txCopy = PoaUnlockHoldingTx.decodeTX(txCopy.encodeTx());
    txCopy.setHash(Hash.computeHash(txCopy));
