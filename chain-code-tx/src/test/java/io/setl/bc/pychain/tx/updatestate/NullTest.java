...
public class NullTest extends BaseTestClass {
  ...
  public void updatestate() throws Exception {
    ...
    AbstractTx thisTX = NullTX.nullUnsigned(chainID, addressNonce++, pubKey, address, "");
    ...
    thisTX = NullTX.nullUnsigned(chainID, addressNonce, pubKey, address, "");
