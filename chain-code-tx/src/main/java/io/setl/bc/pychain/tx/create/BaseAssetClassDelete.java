...
public abstract class BaseAssetClassDelete extends BaseTransaction {
   ...
   */
  public BaseAssetClassDelete(AssetClassDeleteTx tx) {
    super(tx);
  ...
  public abstract AssetClassDeleteTx create();
