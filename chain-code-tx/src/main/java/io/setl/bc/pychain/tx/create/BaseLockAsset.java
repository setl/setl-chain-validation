...
public abstract class BaseLockAsset extends BaseTransaction {
  ...
  @Schema(description = "Details of the lock upon the asset.")
   ...
   */
  public BaseLockAsset(LockAssetTx tx) {
    super(tx);
    ...
    setLockDetails(tx.getLockDetails());
  }


  public abstract LockAssetTx create();
