...
public class ExchangeContract {
  ...
  public static void sign(
      ...
      ExchangeContractData contractData,
    ...
    signOutputs(signer, addressToKeysMapper, contractData, contractAddress, isPoA, authoringAddress);
  ...
  private static void signOutputs(
    ...
    List<NominateAsset> outputs = contractData.getOutputs();
    if (outputs == null) {
      return;
    }
