...
public abstract class BaseAssetClassRegister extends BaseTransaction {
   ...
   */
  public BaseAssetClassRegister(AssetClassRegisterTx tx) {
    super(tx);
  ...
  public abstract AssetClassRegisterTx create();
