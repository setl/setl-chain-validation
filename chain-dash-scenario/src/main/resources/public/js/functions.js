$(document).ready(function(){
    ...
    (function(){
        ...
        /* Active Menu */
        $('#sidebar .menu-item').hover(function(){//when hover.
            $(this).closest('.dropdown').addClass('hovered');
        }, function(){ //when out of hover.
    ...
    (function(){
        setTimeout(function(){
            //Add line-through for already checked items
    ...
    (function(){
        $('body').on('click touchstart', '.drawer-toggle', function(e){
            ...
            $('.drawer:not("#'+drawer+'")').removeClass('toggled'); // remove all the class name 'toggle' for all element that is not 'drawer'.
