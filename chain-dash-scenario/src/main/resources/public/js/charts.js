    ...
    if ($('#dynamic-chart')[0]) {
        ...
        function getRandomData() {
            ...
            while (data.length < totalPoints) {
                var prev = data.length > 0 ? data[data.length - 1] : 50,//equal previous value or equal 50.
                    y = prev + Math.random() * 10 - 5;  //fluctuate from -5 to +5.
                if (y < 0) {
                    y = 0;
                } else if (y > 90) {
                    y = 90;
...
$(function(){
	...
	$('#usa-map').vectorMap({
            ...
            markers :[
                {latLng: [33, -86], name: 'Linode-London'},
                {latLng: [33.7, -93], name: 'linode-Fremont'},
                {latLng: [36, -79], name: 'linode-NewJersey'},
    ...
    $('#world-map').vectorMap({
            ...
            {latLng: [37.5483, -121.9875], name: 'San Francisco'},
            {latLng: [40.314, -74.5089], name: 'NewJersey'},
            {latLng: [1.3667, 103.8], name: 'Singapore'},
            {latLng: [50.110922, 8.682127], name: 'Frankfurt'}
