...
public class StateRequest implements Message {
  ...
  public StateRequest(MPWrappedArray message) {
    this.message = message;
  }


  public StateRequest(int chainId) {
    message = new MPWrappedArrayImpl(new Object[]{chainId, P2PType.STATE_REQUEST.getId()});
  }
