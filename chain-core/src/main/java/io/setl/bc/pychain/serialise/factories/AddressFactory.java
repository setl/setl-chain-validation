...
/**
 * Factory for the leaves of the "assetBalances" Merkle.
 *
 * @author Simon Greatrix on 09/10/2019.
 */
@Component
public class AddressFactory extends MsgPackableFactory<AddressEntry> implements MerkleLeafFactory<AddressEntry> {

  public AddressFactory() {
    super(AddressEntry.class);
  }


  @Override
  public ContentFactory<AddressEntry> getFactory() {
    return this;
  }
