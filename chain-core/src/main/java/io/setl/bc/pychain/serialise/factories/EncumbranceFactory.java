...
/**
 * Factory for the leaves of the "encumbrances" Merkle tree.
 *
 * @author Simon Greatrix on 09/10/2019.
 */
@Component
public class EncumbranceFactory extends MsgPackableFactory<AddressEncumbrances> implements MerkleLeafFactory<AddressEncumbrances> {

  public EncumbranceFactory() {
    super(AddressEncumbrances.class);
  }


  @Override
  public ContentFactory<AddressEncumbrances> getFactory() {
    return this;
  }
