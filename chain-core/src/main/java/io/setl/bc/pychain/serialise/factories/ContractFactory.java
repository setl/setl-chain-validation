 ...
 */
@Component
public class ContractFactory implements MerkleLeafFactory<ContractEntry> {

  @Override
  public ContentFactory<ContractEntry> getFactory() {
    return new ObjectArrayFactory<>(ContractEntry.class, new ContractEntry.Decoder());
  }
}