...
/**
 * Factory for the leaves of the "sign nodes" Merkle.
 *
 * @author Simon Greatrix on 09/10/2019.
 */
@Component
public class SignNodeFactory extends MsgPackableFactory<SignNodeEntry> implements MerkleLeafFactory<SignNodeEntry> {

  public SignNodeFactory() {
    super(SignNodeEntry.class);
  }


  @Override
  public ContentFactory<SignNodeEntry> getFactory() {
    return this;
  }
